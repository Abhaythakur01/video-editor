...
const Portfolio = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-pink-500/10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-1/3 left-1/4 w-60 h-60 bg-cyan-400/10 rounded-full blur-2xl animate-pulse delay-1000"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-pink-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">FOLIO</span>
          </h2>
            ...
            <button
              ...
              className={`px-6 py-3 rounded-xl font-medium transition-all duration-500 ease-out backdrop-blur-lg border ${
                activeFilter === filter.id
                  ? 'bg-gradient-to-r from-pink-500 to-purple-500 text-white border-transparent shadow-lg shadow-purple-500/20'
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl bg-slate-900/40 backdrop-blur-lg border border-white/10 hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-1000 ease-out">
                {/* Image */}
                <div className="aspect-video relative overflow-hidden">
                  ...
                  {/* Smooth Overlay */}
                  <div className="absolute inset-0 bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-cyan-400/10 opacity-0 group-hover:opacity-100 group-hover:scale-105 transition-all duration-1000 ease-in-out flex items-center justify-center">
                ...
                <div className="p-6 transition-all duration-700 ease-out group-hover:translate-y-[-4px]">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xl font-bold text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:via-purple-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all duration-1000 ease-in-out">
                      {project.title}
                    </h3>
