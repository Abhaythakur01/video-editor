    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="w-full h-full bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-pink-500/20 via-purple-500/30 to-cyan-400/20 animate-pulse"></div>
          {/* Subtle mesh pattern */}
          <div className="absolute inset-0 opacity-30" 
               style={{
                 backgroundImage: `radial-gradient(circle at 25% 25%, #FF6B9D22 0%, transparent 50%),
                                  radial-gradient(circle at 75% 75%, #00F5FF22 0%, transparent 50%),
                                  radial-gradient(circle at 50% 50%, #C147E922 0%, transparent 50%)`
               }}>
          </div>
          {/* Bottom fade */}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-48 h-48 bg-pink-500/10 rounded-full blur-xl animate-pulse" 
             style={{ willChange: 'opacity' }}></div>
        <div className="absolute bottom-1/3 left-1/4 w-32 h-32 bg-cyan-400/15 rounded-full blur-lg animate-pulse" 
             style={{ willChange: 'opacity', animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-purple-500/20 rounded-full blur-md animate-pulse" 
             style={{ willChange: 'opacity', animationDelay: '2s' }}></div>
      </div>

      {/* Content */}
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        {/* Name with optimized animation */}
        <h1 className={`text-6xl md:text-8xl font-bold mb-4 transition-all duration-1000 ease-out ${
        ...
        <div className={`text-xl md:text-2xl mb-8 transition-all duration-1000 ease-out delay-300 ${
        ...
        {/* Modern CTA Buttons */}
        <div className={`flex flex-col sm:flex-row gap-4 justify-center mb-16 transition-all duration-1000 ease-out delay-500 ${
          titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}
        style={{ willChange: 'opacity, transform' }}>
        ...
        <div className={`flex justify-center items-center gap-6 text-sm text-slate-400 transition-all duration-1000 delay-700 ${
          titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}>
